    ...
    <div class="header_meta">
        <div class="container">
            <div class="weather_forecast">
                <span class="city">Arsip Artikel</span>
                            ...
                            <div class="layout_post_2 clearfix">
                                <div class="item_thumb">
                                    ...
                                    <div class="thumb_meta">
                                        <span class="category"><a href="/artikel/{{ $artikelz->id }}/show">{{ $artikelz->kategori }}</a></span>
                                        <span class="comments"><a href="/artikel/{{ $artikelz->id }}/show">By {{ $artikelz->nama }}</a></span>
                                    </div>
                                </div>
                                <div class="item_content">
                                    <h4><a href="/artikel/{{ $artikelz->id }}/show">{{ $artikelz->judul }}</a></h4>
