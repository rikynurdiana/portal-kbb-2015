        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Input Artikel <small>baru</small></h2>
                        ...
                        <div class="x_content">
                            {!! Form::model(new App\Http\Models\Artikel, ['class' => 'form-horizontal','files'=>true, 'route' => ['artikel.store']]) !!}
                            <form class="form-horizontal form-label-left" novalidate>
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="judul">Judul Artikel <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="judul" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" name="judul" required="required" type="text" placeholder="masukan judul artikel">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="deskripsi">Isi Artikel <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea id="deskripsi" data-validate-length-range="6" required="required" name="deskripsi" class="form-control col-md-7 col-xs-12" placeholder="masukan isi artikel"></textarea>
                                    </div>
                                </div>
                                <div class="item form-group">
                                ...
                                <div class="form-group">
                                    {!! Form::label('gambar', 'Gambar Artikel', array('class' => 'col-md-4 control-label'))  !!}
                                    <div class="col-md-6">
                                ...
                                <div class="x_title">
                                    <h2>Data Pembuat Artikel <small>Wajib di isi</small></h2>
                                    <ul class="nav navbar-right panel_toolbox ">
                                    </ul>
                                    <div class="clearfix"></div>
                                </div>
                                ...
                                <div class="form-group">
                                    {!! Form::label('profile', 'Foto Pembuat Artikel', array('class' => 'col-md-4 control-label'))  !!}
                                    <div class="col-md-6">
                                ...
                                <div class="ln_solid"></div>
                                <div class="x_title">
                                    <h2>Editor Review Artikel <small>Wajib di isi</small></h2>
                                    <ul class="nav navbar-right panel_toolbox ">
                                    </ul>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nilai_isi">Nilai untuk isi artikel ( 1 - 10 ) <span class="required">*</span>
                                    </label>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nilai_informatif">Apakah artikel informatif ? ( 1 - 10 ) <span class="required">*</span>
                                    </label>
                                    <div class="col-md-2 col-sm-6 col-xs-12">
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nilai_penyajian">Apakah penyajian artikel bagus ? ( 1 - 10 ) <span class="required">*</span>
                                    </label>
                                    <div class="col-md-2 col-sm-6 col-xs-12">
