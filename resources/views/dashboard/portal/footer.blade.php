                    ...
                    <div class="tb_widget_top_rated clearfix">
                        ...
                        <div class="item clearfix">
                            <div class="item_thumb clearfix">
                                <a href="/berita/{{ $beritas->id }}/show"><img src="{{ asset($beritas->gambar) }}" height="55px"></a>
                            </div>
                        ...
                        <div class="item clearfix">
                            <div class="item_thumb">
                                ...
                                <div class="thumb_hover">
                                    <a href="/pengumuman/{{ $pengumumans->id }}/show"><img src="{{ asset($pengumumans->gambar) }}" height="55px"></a>
                                </div>
                            </div>
                            <div class="item_content">
