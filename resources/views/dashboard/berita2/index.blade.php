                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            <ul class="nav navbar-right panel_toolbox ">
                                <li><a href="/berita2/create" type="button" class="btn btn-success">Tambah Berita</a></li>
                                    ...
                                    @foreach( $berita2 as $beritas )
                                        <tbody>
                                            <tr class="even pointer">
                                                {!! Form::open(array('class' => 'form-inline', 'method' => 'DELETE', 'route' => array('berita2.destroy', $beritas->id))) !!}
                                                <td class="a-center "></td>
                                                <td class=" ">{{ $beritas->judul }}</td>
                                                <td class=" ">{{ $beritas->ringkasan }}</td>
                                                <td class=" ">{{ $beritas->kategori }}</td>
                                                <td><center>{!! link_to_route('berita2.edit', 'Edit', array($beritas->id), array('class' => 'btn btn-info')) !!}</center></td>
