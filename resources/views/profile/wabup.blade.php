        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-right">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="/profile/bupati">Profile Bupati</a></li>
                        ...
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">Drs.H. Yayat Turochmat Soemitra</h1>
                                    <h2 class="animation animated-item-2">Wakil Bupati Kabupaten Bandung Barat</h2>
                                </div>
                            </div>

                            <div class="col-sm-6 hidden-xs animation animated-item-4">
                                <div class="slider-img">
                                    <img src="{{ asset('images/b2.png') }}" class="img-responsive">
                                </div>
                            </div>
                        </div>
                    </div>
                              ...
                              <div class="panel-body">
                                  <div class="media accordion-inner">
                                    <div class="media-body">
                                         <p>Nama Lengkap : Drs.H. Yayat Turochmat Soemitra</p>
                                         <p>Tempat, Tanggal Lahir : Bandung, 11 Juli 1960</p>
                                         <p>Agama : Islam</p>
                                         <p></p>
                                    </div>
                                  </div>
            ...
            <div class="row">
                  ...
                  <ul class="timeline">
                    <li class="wow fadeInLeft" data-wow-delay="1.5s">
                      ...
                      <div class="timeline-panel">
                        <div class="timeline-heading">
                          <h4 class="timeline-title">Sekretaris Jenderal Ikatan Nasional Tenaga ahli Konsultan Indonesia</h4>
                          <p><small class="text-muted"><i class="glyphicon glyphicon-time"></i> Periode 2005-2013</small></p>
                        </div>
                      </div>
                    </li>
                    <li class="timeline-inverted wow fadeInRight" data-wow-delay="1s">
                      ...
                      <div class="timeline-panel">
                        <div class="timeline-heading">
                          <h4 class="timeline-title">Anggota Majelis Pertimbangan LPJKN</h4>
                    ...
                    <li class="timeline-inverted wow fadeInRight" data-wow-delay="1s">
                        <div class="timeline-badge success">2004</div>
                      <div class="timeline-panel">
                        <div class="timeline-heading">
                          <h4 class="timeline-title">Kompartemen Konsultansi KADIN Indonesia</h4>
                          <p><small class="text-muted"><i class="glyphicon glyphicon-time"></i> Tahun 1999-2004</small></p>
                        </div>
                      </div>
                    </li>
                    <li class="wow fadeInLeft" data-wow-delay="1s">
                      ...
                      <div class="timeline-panel">
                        <div class="timeline-heading">
                          <h4 class="timeline-title">Dewan Pengurus Kelompok relawan Pengembangan Jasa Kontruksi Nasional</h4>
                          <p><small class="text-muted"><i class="glyphicon glyphicon-time"></i> Tahun 1998-2002</small></p>
                        </div>
                      </div>
                    </li>
                    <li class="timeline-inverted wow fadeInRight" data-wow-delay="1s">
                        <div class="timeline-badge success">1995</div>
                      <div class="timeline-panel">
                        <div class="timeline-heading">
                          <h4 class="timeline-title">Wakil Ketua Umum Presedium GMNI Pusat pada tahun</h4>
                          <p><small class="text-muted"><i class="glyphicon glyphicon-time"></i> Tahun 1992-1995</small></p>
                        </div>
                      </div>
                    </li>
                    <li class="wow fadeInLeft" data-wow-delay="1s">
                      ...
                      <div class="timeline-panel">
                        <div class="timeline-heading">
                          <h4 class="timeline-title">Ketua Cabang GMNI Bandung pada tahun</h4>
                          <p><small class="text-muted"><i class="glyphicon glyphicon-time"></i> Tahun 1986-1988</small></p>
                        </div>
                      </div>
                    </li>
                    <li class="timeline-inverted wow fadeInRight" data-wow-delay="1s">
                        <div class="timeline-badge info">1984</div>
                      <div class="timeline-panel">
                        <div class="timeline-heading">
                          <h4 class="timeline-title">Senat Mahasiswa Fakultas Ilmu Pendidikan IKIP Bandung</h4>
                          <p><small class="text-muted"><i class="glyphicon glyphicon-time"></i> Tahun 1983-1984</small></p>
                        </div>
                      </div>
                    </li>
                    <li class="wow fadeInLeft" data-wow-delay="1s">
                      <div class="timeline-badge warning">1982</div>
                      <div class="timeline-panel">
                        <div class="timeline-heading">
                          <h4 class="timeline-title">Ketua Himpunan Mahasiswa Jurusan</h4>
                          <p><small class="text-muted"><i class="glyphicon glyphicon-time"></i> Tahun 1981-1982</small></p>
                        </div>
                      </div>
                    </li>
                    <li class="timeline-inverted wow fadeInRight" data-wow-delay="1s">
                      ...
                      <div class="timeline-panel">
                        <div class="timeline-heading">
                          <h4 class="timeline-title">Ketua Angkatan Mahasiswa Baru tahun</h4>
                          <p><small class="text-muted"><i class="glyphicon glyphicon-time"></i> Tahun 1980</small></p>
                        </div>
                      </div>
                    </li>
                    <li class="wow fadeInLeft" data-wow-delay="1s">
                      ...
                      <div class="timeline-panel">
                        <div class="timeline-heading">
                          ...
                          <p><small class="text-muted"><i class="glyphicon glyphicon-time"></i> Tahun 1978-1980</small></p>
                        </div>
                      </div>
                    </li>
                    <li class="timeline-inverted wow fadeInRight" data-wow-delay="1s">
                      ...
                      <div class="timeline-panel">
                        <div class="timeline-heading">
                          <h4 class="timeline-title">Ketua Pusat Gerakan Siswa Nasional Indonesia</h4>
                          <p><small class="text-muted"><i class="glyphicon glyphicon-time"></i> Tahun 1993</small></p>
                        </div>
                      </div>
                    </li>
                  </ul>
