                        ...
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">NAMA SEKDA</h1>
                                    <h2 class="animation animated-item-2">SEKDA Kabupaten Bandung Barat</h2>
                                </div>
                            </div>

                            <div class="col-sm-6 hidden-xs animation animated-item-4">
                                <div class="slider-img">
                                    <img src="{{ asset('images/bussines-man.png') }}" class="img-responsive">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <ul class="pull-right">
                            ...
                            <li><a href="/profile/bupati">Profile Bupati</a></li>
                            <li><a href="/peofile/wabup">Profile Wakil Bupati</a></li>
                        </ul>
                    </div>
                </div>
            </div>
